...
/*   Updated: 2019/11/08 19:10:04 by nsheev           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	sw_x_min(t_flags *l, int len, int *i, unsigned long long a)
{
	int k;
...
static int	sw_x_zer(t_flags *l, int len, int *i, unsigned long long a)
{
	int k;
...
static int	sw_x_els(t_flags *l, int len, int *i, unsigned long long a)
{
	int k;
